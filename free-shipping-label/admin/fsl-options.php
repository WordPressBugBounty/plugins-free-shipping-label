        ...
        $progress_bar = [
            ...
            [
                ...
                'options' => [
                    ...
                    '_disabled_5'                     => esc_html__( 'Before Cart table', 'free-shipping-label' ),
                    '_disabled_6'                     => esc_html__( 'After Cart table', 'free-shipping-label' ),
                    '_disabled_7'                     => esc_html__( 'Cart table (before items)', 'free-shipping-label' ),
                    '_disabled_8'                     => esc_html__( 'Cart table (after items)', 'free-shipping-label' ),
                ],
